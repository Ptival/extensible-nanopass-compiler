...
Section If2.
  ...
  Global Instance IndexedFunctor_EvalRelation__If2
    : IndexedFunctor (WellFormedValue E * WellFormedValue V) EvalRelation__If2.
  Proof.
    constructor.
    move => A B i IH [].
  ...
  Definition EvalInversionClear__If2
             ...
             (IH__True : forall c t e t',
                 ...
                 EvalRelation__E (t, t') ->
                 (if2 c t e, t') = ev ->
                 P EvalRelation__E (if2 c t e, t')
             )
             (IH__False : forall c t e e',
                 EvalRelation__E (c, boolean false) ->
                 EvalRelation__E (e, e') ->
                 (if2 c t e, e') = ev ->
                 P EvalRelation__E (if2 c t e, e')
             )
    ...
    :=
      ...
      | If2True _ c t e t' E__c E__t =>
        fun EQ => eq_ind (if2 c t e, t') (P EvalRelation__E) (IH__True c t e t' E__c E__t EQ) ev EQ
      | If2False _ c t e e' E__c E__e =>
        fun EQ => eq_ind (if2 c t e, e') (P EvalRelation__E) (IH__False c t e e' E__c E__e EQ) ev EQ
      end eq_refl.
